...
class _$UserImpl with DiagnosticableTreeMixin implements _User {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'User(userId: $userId, name: $name, email: $email, passwordHash: $passwordHash, passwordSalt: $passwordSalt, createdAt: $createdAt, status: $status, challenges: $challenges, results: $results)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('passwordHash', passwordHash))
      ..add(DiagnosticsProperty('passwordSalt', passwordSalt))
...
abstract class _User implements User {
  factory _User(
      ...
      required final List<Challenge> challenges,
      required final List<Result> results}) = _$UserImpl;
